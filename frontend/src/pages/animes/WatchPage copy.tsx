...
export default function WatchPage() {
    ...
    useModalBackButton(isEpisodesModalOpen, () => setIsEpisodesModalOpen(false));
    useModalBackButton(isReportModalOpen, () => setIsReportModalOpen(false));
    useModalBackButton(isEpisodeInfoOpen, () => setIsEpisodeInfoOpen(false));
    useModalBackButton(isShareModalOpen, () => setIsShareModalOpen(false));
            ...
            <div className="animate-fade-in w-full">
                ...
                <div className="w-full min-h-screen">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 overflow-visible min-h-screen">
                        ...
                        <div className="hidden lg:block lg:col-span-2 sticky top-[75px] h-[calc(100vh-75px)] overflow-y-auto custom-scrollbar bg-white dark:bg-black z-30">
                            <SocialNavSidebar />
                        </div>
                        ...
                        {(!anime || !currentEpisode || isLoading || isLoadingActiveEpisode) ? (
                            ...
                            <>
                                ...
                                <div ref={sidebarRef} className="hidden lg:block lg:col-span-3 sticky top-[75px] h-[calc(100vh-75px)] overflow-y-auto custom-scrollbar bg-transparent z-30 px-2 pt-2 md:pt-4 pb-4">
                                    ...
                                    <div className="bg-white dark:bg-black shadow-sm rounded-xl overflow-hidden p-1 space-y-1">
                                                ...
                                                {displayedEpisodesView.map((ep: any) => {
                                                    ...
                                                    return (
                                                        <div
                                                            key={ep.id}
                                                            className={cn(
                                                                "group relative flex items-start gap-3 p-3 transition-all rounded-xl",
                                                                isActive ? "bg-white/10 dark:bg-white/5 shadow-sm" : "hover:bg-gray-50 dark:hover:bg-[#111]"
                                                            )}
                                                        >
                                                            {/* Large Number + Hashtag */}
                                                            <div className={cn(
                                                                "text-3xl md:text-4xl font-black italic tracking-tighter transition-colors shrink-0 w-12 text-center pt-1 md:pt-2",
                                                                isActive ? "text-black dark:text-white" : "text-gray-300 dark:text-[#333] group-hover:text-gray-400 dark:group-hover:text-[#444]"
                                                            )}>
                                                                #{ep.episode_number}
                                                            </div>
                                                            ...
                                                            <div className="flex-1 flex flex-col min-w-0 relative">
                                                                ...
                                                                >
                                                                    ...
                                                                    <div className="w-full px-1">
                                                                        <h4 className={cn(
                                                                            "text-[13px] md:text-sm font-black line-clamp-2 transition-colors leading-tight",
                                                                            isActive ? "text-black dark:text-white" : "text-gray-900 dark:text-gray-100 group-hover/link:text-blue-500"
                                                                        )}>
                                                                            {epItemTitle}
                                                                        </h4>
                                                                        <p className={cn("text-[11px] mt-1 line-clamp-1 font-bold", isActive ? "text-black/70 dark:text-white/80" : "text-gray-500")}>
                                                                            {lang === 'ar' ? `حلقة ${ep.episode_number}` : `Episode ${ep.episode_number}`}
                                                                        </p>
                                                                    </div>
                                                                </Link>

                                                                {/* Hover Actions - OUTSIDE Link to prevent navigation on click */}
                                            ...
                                            <AnimatePresence>
                                                {(isFetchingNextPage || hasNextPage) && (
                                                    <motion.div 
                                                        ...
                                                        className="py-6 flex flex-col items-center justify-center bg-black/80 backdrop-blur-md overflow-hidden rounded-xl mt-2 mx-1 shadow-lg"
                                                    >
