        ...
        <div dir={lang === 'ar' ? 'rtl' : 'ltr'} className="min-h-screen bg-[#f0f2f5] dark:bg-black text-gray-900 dark:text-white font-sans transition-colors duration-300">
            ...
            <div className="w-full min-h-screen flex flex-col items-center">
                <div className="w-full max-w-7xl min-h-screen flex flex-col">
                    ...
                    {isLoading ? (
                        <div className="flex-1 flex items-center justify-center h-[70vh] w-full">
                        ...
                        <>
                            {/* Main Content Area */}
                            <div className="w-full border-x-0 lg:border-x border-gray-100 dark:border-[#2a2a2a] rtl:lg:border-x">
                                <div className="flex flex-col min-h-screen">
                                    ...
                                    {error || !anime ? (
                                        ...
                                        <div className="animate-fade-in w-full">
                                            {/* HERO SECTION */}
                                            <div className="relative w-full h-[35vh] md:h-[45vh] overflow-hidden group">
                                                {/* Background Image */}
