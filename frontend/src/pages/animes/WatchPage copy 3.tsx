        ...
        <div dir={lang === 'ar' ? 'rtl' : 'ltr'} className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white font-sans transition-colors duration-300">
            ...
            {isLoading ? (
                ...
                <div className="animate-fade-in relative z-10 w-full pt-0">
                    ...
                    <div className="block md:hidden w-full aspect-video bg-black overflow-hidden relative md:mb-6 mb-0">
                    ...
                    <div className="max-w-[1200px] mx-auto px-4 md:px-6 py-0 animate-fade-in">
                        <div className="grid items-start grid-cols-1 gap-6 lg:grid-cols-12 grid-flow-dense">
                            {/* MAIN CONTENT 1: Player Wrapper (Desktop Only) */}
                            <div className={`hidden md:flex flex-col mt-0 transition-all duration-500 ease-in-out ${isTheaterMode ? 'lg:col-span-12 xl:col-span-12 w-full lg:w-[90%] mx-auto' : 'lg:col-span-7 xl:col-span-7'}`}>
                                <div className="w-full aspect-video bg-black overflow-hidden shadow-xl mb-6 relative group">
                                    {!isPlaying ? (
                            ...
                            <div className="flex flex-col mt-0 lg:col-span-7 xl:col-span-7 transition-all duration-500 relative z-10">
                                ...
                                {/* Servers Section - NOW BELOW STATS */}
                                            ...
                                            <div className="flex flex-wrap items-center gap-2">
                                                {servers.length > 0 ? (
                                                    servers.map((server: any, idx: number) => {
                                                        // Find the matching global server to get its image
                                ...
                                <div className="mb-4 w-full mt-1 md:-mt-10 border-gray-200 dark:border-[#333] pt-4">
                            ...
                            <div className="lg:col-span-12 mb-10 -mt-4">
