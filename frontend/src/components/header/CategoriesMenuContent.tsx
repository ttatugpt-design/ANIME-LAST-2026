...
export function CategoriesMenuContent({ onClose, isVisible }: CategoriesMenuContentProps) {
    ...
    return (
        <div className="flex w-full h-[380px] bg-white dark:bg-[#0a0a0a] overflow-hidden relative">
            {/* Global Spinner */}
            {isCategoriesLoading && (
            ...
            <div className="w-[280px] bg-gray-50/50 dark:bg-neutral-900/30 border-l border-gray-100 dark:border-neutral-800 flex flex-col rtl:order-1 rtl:border-l-0 rtl:border-r">
                <div className="p-6 border-b border-gray-100 dark:border-neutral-800 flex items-center justify-between">
                    <h4 className="text-sm font-black text-gray-400 uppercase tracking-widest">{isRtl ? 'تصفح حسب الفئة' : 'Browse by category'}</h4>
                    ...
                    {categories?.map((cat: any) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className={cn(
                                    "text-lg font-black transition-colors leading-tight mr-4",
